...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 19, 2022 lúc 08:42 AM
...
--
-- Cấu trúc bảng cho bảng `tbl_blocked_id`
--

CREATE TABLE `tbl_blocked_id` (
  `ip` varchar(255) NOT NULL,
  `last_login_failed` bigint(20) DEFAULT NULL,
  `num_wrong` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Cấu trúc bảng cho bảng `tbl_collections`
--
...
--
-- Đang đổ dữ liệu cho bảng `tbl_collections`
--
...
--
-- Cấu trúc bảng cho bảng `tbl_favorite_products`
--
...
--
-- Cấu trúc bảng cho bảng `tbl_mail_register`
--
...
--
-- Cấu trúc bảng cho bảng `tbl_rate_product`
--
...
--
-- Cấu trúc bảng cho bảng `tbl_saledorder_products`
--
...
--
-- Cấu trúc bảng cho bảng `tbl_tagsearch`
--
...
--
-- Đang đổ dữ liệu cho bảng `tbl_tagsearch`
--
...
(1, NULL, '2021-11-17 14:17:11.000000', NULL, NULL, NULL, 'admin@gmail.com', b'1', 'admin', '$2a$10$K4D.WGfIxZVORHrUJ32RGOIevukRP9UFKUoiIIv8J1B0UTcRpXFeS', NULL, 'admin'),
(2, NULL, '2021-11-17 14:17:34.000000', NULL, NULL, NULL, 'admin@gmail.com', b'1', 'tester', '$2a$10$K4D.WGfIxZVORHrUJ32RGOIevukRP9UFKUoiIIv8J1B0UTcRpXFeS', NULL, 'tester'),
(3, NULL, '2021-11-17 14:17:49.000000', NULL, NULL, NULL, 'tho@gmail.com', b'1', 'Đức Thọ', '$2a$10$K4D.WGfIxZVORHrUJ32RGOIevukRP9UFKUoiIIv8J1B0UTcRpXFeS', NULL, 'tho'),
(4, NULL, NULL, NULL, NULL, NULL, 'abc@gmail.com', b'1', 'Thọ', '$2a$10$K4D.WGfIxZVORHrUJ32RGOIevukRP9UFKUoiIIv8J1B0UTcRpXFeS', NULL, 'dth');
...
--
-- Chỉ mục cho bảng `tbl_blocked_id`
--
ALTER TABLE `tbl_blocked_id`
  ADD PRIMARY KEY (`ip`);
...
--
-- Chỉ mục cho bảng `tbl_collections`
--
...
--
-- Chỉ mục cho bảng `tbl_favorite_products`
--
...
--
-- Chỉ mục cho bảng `tbl_mail_register`
--
...
--
-- Chỉ mục cho bảng `tbl_rate_product`
--
...
--
-- Chỉ mục cho bảng `tbl_saledorder_products`
--
...
--
-- Chỉ mục cho bảng `tbl_tagsearch`
--
...
--
-- AUTO_INCREMENT cho bảng `tbl_collections`
--
ALTER TABLE `tbl_collections`
...
--
-- AUTO_INCREMENT cho bảng `tbl_mail_register`
--
ALTER TABLE `tbl_mail_register`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `tbl_saledorder_products`
--
ALTER TABLE `tbl_saledorder_products`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `tbl_tagsearch`
--
ALTER TABLE `tbl_tagsearch`
...
--
-- Các ràng buộc cho bảng `tbl_favorite_products`
--
ALTER TABLE `tbl_favorite_products`
